...
class school_report_class_provisional(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(school_report_class_provisional, self).__init__(
                cr,
                uid,
                name,
                context=context)
...
report_sxw.report_sxw(
    'report.school.class.print.provisional',
    'school.class',
    'addons/school/report/school_class_provisional_list.rml',
    parser=school_report_class_provisional,
    header="internal")
